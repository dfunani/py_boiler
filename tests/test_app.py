    ...
    def test_basic_command_creates_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert "✅ Created README.md with Hello World template." in result.output
                assert "✅ Created app.py with Hello World template." in result.output
                assert "✅ Created .gitignore with Hello World template." in result.output
                assert "✅ Created __init__.py with Hello World template." in result.output
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                for file in existing_files:
                    ...
                    assert f"⚠️  {file} already exists, not overwriting." in result.output
    ...
    def test_basic_command_file_contents(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                assert "A simple boilerplate generator for Python projects." in readme_content
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                for file in other_files:
                    assert Path(file).exists()
                    assert f"✅ Created {file} with Hello World template." in result.output
